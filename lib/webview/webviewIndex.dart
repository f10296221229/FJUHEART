...
class _WebViewIndexState extends State<WebViewIndex> {
  ...
  void initState() {
      ...
      ..setNavigationDelegate(
        NavigationDelegate(
          onProgress: (int progress) async {
            ...
            Object html = await _controller.runJavaScriptReturningResult(
                "sessionStorage.setItem('MEMBER_ID', '${result![0]
                    .account}');sessionStorage.setItem('MEMBER_FLAG', 1);"
          ...
          onPageStarted: (String url) async {
            ...
            Object html = await _controller.runJavaScriptReturningResult(
                "sessionStorage.setItem('MEMBER_ID', '${result![0]
                    .account}');sessionStorage.setItem('MEMBER_FLAG', 1);document.getElementById('ctn1').style.display='none';");
    ...
    // ..loadRequest(Uri.parse('https://www.gintac.com.tw/fjuheart/'));
    // ..loadRequest(Uri.parse('http://localhost:8080/devmvc/'));
      ..loadRequest(
