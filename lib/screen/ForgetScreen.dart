  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          title: const Text('忘記密碼',style: TextStyle(color: Color.fromRGBO(255, 255, 255, 1))),
        ),
        body: ListView(
          children: const [
            //  Image.asset(
    ...
    return Container(
        ...
        child: SizedBox(
          //用来设置宽高，如直接使用RaisedButton则不能设置
            ...
            child: ElevatedButton(
              //一个凸起的材质矩形按钮
                style: ElevatedButton.styleFrom(backgroundColor:  const Color.fromRGBO(51, 204, 204, 1.0)),
                // color: Colors.red,
                child: const Text(
                  '寄送郵件',
                ...
                onPressed: () async {
                  ...
                  if (_accountState) {
                    var f = await resp(_accountController.text);
                    if (f == "Y") {
                      _dialogBuilder(context, "寄送信箱完成");
                      // Navigator.pushNamed(context, '/Home');
...
Future resp(String account) async {
  String flag = "";
  final response = await http.post(
    Uri.parse('http://211.20.21.35:8080/fjuheart/MH100203/resetpasswordmail'),
